...
void test_foul_bits_no_bleed_into_winner() {
    // No foul bit should overlap with any winner bit
    TEST_ASSERT_EQUAL(0, (foul_left  & winner_leftWin));
    TEST_ASSERT_EQUAL(0, (foul_left  & winner_rightWin));
    TEST_ASSERT_EQUAL(0, (foul_right & winner_leftWin));
    TEST_ASSERT_EQUAL(0, (foul_right & winner_rightWin));
}
...
int main(int argc, char **argv) {
    ...
    RUN_TEST(test_foul_bits_no_bleed_into_winner);
